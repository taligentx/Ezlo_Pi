...
void ezlopi_device_print_properties(s_ezlopi_device_properties_t *device)
{
    if (device)
    {
        ...
        TRACE_D("device->ezlopi_cloud.device_id: 0x%016llx", device->ezlopi_cloud.device_id);
        // TRACE_D("device->ezlopi_cloud.room_id: 0x%016llx", device->ezlopi_cloud.room_id);
        TRACE_D("device->ezlopi_cloud.room_id: \"\"");
        TRACE_D("device->ezlopi_cloud.item_id: 0x%016llx", device->ezlopi_cloud.item_id);
